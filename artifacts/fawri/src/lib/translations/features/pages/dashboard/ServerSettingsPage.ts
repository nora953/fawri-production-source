...
export const SERVER_SETTINGS_PAGE_COPY = {
  ar: {
    ...
    inventoryFreshness: 'حداثة المخزون والطلبات الإلكترونية',
    freshnessMinutes: 'المدة قبل اعتبار المخزون قديمًا (بالدقائق)',
    stalePolicy: 'عند قدم المخزون',
    staleReroutePending: 'استخدم موقعًا حديثًا آخر، وإن لم يوجد فانتظر تأكيد التنفيذ',
    staleAllow: 'استمر بالمخزون القديم مع تحمل المخاطرة',
    staleFreshOnly: 'لا تستخدم المواقع ذات المخزون القديم للطلبات الإلكترونية',
    payment: 'الدفع',
