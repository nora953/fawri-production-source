...
export const SERVER_SETTINGS_PAGE_COPY = {
  ar: {
    ...
    inventoryFreshness: 'تحديث المخزون للطلبات الإلكترونية',
    freshnessMinutes: 'المدة قبل اعتبار بيانات المخزون غير مُحدَّثة (بالدقائق)',
    stalePolicy: 'عند عدم تحديث المخزون',
    staleReroutePending: 'استخدم موقعًا آخر بمخزون مُحدَّث، وإن لم يوجد فانتظر تأكيد التنفيذ',
    staleAllow: 'استمر باستخدام المخزون غير المُحدَّث مع تحمّل المخاطرة',
    staleFreshOnly: 'لا تستخدم المواقع ذات المخزون غير المُحدَّث للطلبات الإلكترونية',
    payment: 'الدفع',
  ...
  ku: {
    ...
    inventoryFreshness: 'نوێیی کۆگا و داواکارییە ئۆنلاینەکان',
    freshnessMinutes: 'ماوە پێش ئەوەی کۆگا بە کۆن هەژمار بکرێت (خولەک)',
    stalePolicy: 'کاتێک زانیاری کۆگا کۆن بوو',
    staleReroutePending: 'شوێنێکی نوێتر بەکاربهێنە، ئەگەر نەبوو چاوەڕێی پشتڕاستکردنەوەی جێبەجێکردن بکە',
    staleAllow: 'بە زانیاری کۆنی کۆگا بەردەوام بە وەرگرتنی مەترسی',
    staleFreshOnly: 'شوێنی کۆنی کۆگا بۆ داواکاری ئۆنلاین بەکارمەهێنە',
    payment: 'پارەدان',
  ...
  en: {
    ...
    inventoryFreshness: 'Inventory freshness and online orders',
    freshnessMinutes: 'Minutes before inventory is considered stale',
    stalePolicy: 'When inventory becomes stale',
    staleReroutePending: 'Use another fresh location; otherwise require fulfillment confirmation',
    staleAllow: 'Continue using stale inventory and accept the risk',
    staleFreshOnly: 'Do not use stale locations for online fulfillment',
    payment: 'Payment',
