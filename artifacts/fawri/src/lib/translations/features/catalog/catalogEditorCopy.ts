...
export const CATALOG_PRODUCT_DETAILS_COPY = {
  ar: {
    ...
    inheritanceHint: (price: string, cost: string) => `سعر البيع ${price || '—'} والكلفة ${cost || '—'} وصور المنتج هي الافتراضية لكل الأنواع. اكتب فقط القيمة المختلفة عند الحاجة.`,
    ...
    excludedTitle: 'أنواع غير متوفرة',
  ...
  ku: {
    quantity: 'بڕ',
    inventoryAfterSave: 'کۆگای جۆر پاشەکەوتکراوەکان دوای پاشەکەوتکردن لە ئامرازەکانی کۆگا بگۆڕە.',
    ...
    inheritanceHint: (price: string, cost: string) => `نرخی ${price || '—'} و تێچووی ${cost || '—'} و وێنەکانی بەرهەم بۆ هەموو جۆرەکان بنەڕەتین. تەنها جیاوازییەکان بنووسە.`,
    ...
    tooMany: 'ژمارەی جۆرەکان لە 100 زیاترە.',
    existingVariants: 'ئەم بەرهەمە جۆری پاشەکەوتکراوی هەیە و ناتوانرێت چەند هەڵبژاردەیی ناچالاک بکرێت.',
    ...
    excludeCombination: 'لابردنی جۆر',
    excludedTitle: 'جۆر بەردەست نییەکان',
    excludedHint: 'ئەم جۆرانە لە نوێکردنەوەدا دووبارە دروست نابن. پێش پاشەکەوتکردن دەتوانیت بیانگەڕێنیتەوە.',
  ...
  en: {
    ...
    inheritanceHint: (price: string, cost: string) => `Sale price ${price || '—'}, cost ${cost || '—'}, and product images are the defaults for every variant. Enter only what is different.`,
    ...
    excludedTitle: 'Unavailable variants',
