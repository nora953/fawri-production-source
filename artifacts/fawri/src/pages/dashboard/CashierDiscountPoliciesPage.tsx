...
const TEXT: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    subtitle: 'اختر نوع خصم واحد للتاجر، ثم حدد حد كل موظف لهذا النوع.',
    back: 'العودة للكاشيرات والموظفين',
    discountType: 'نوع الخصم المعتمد',
    discountTypeHint: 'هذا الاختيار يطبق على جميع الكاشير والمديرين. الموظف لا يستطيع تغيير نوع الخصم من شاشة البيع.',
    amountType: 'مبلغ ثابت',
    percentageType: 'نسبة مئوية',
    saveType: 'حفظ نوع الخصم',
    typeSaved: 'تم حفظ نوع الخصم للتاجر.',
    enabled: 'السماح بالخصم اليدوي',
    maxPercent: 'الحد الأقصى لنسبة الخصم (%)',
    maxAmount: 'الحد الأقصى للخصم بالمبلغ',
    independentLimitHint: 'تجاوز حد الموظف يتطلب موافقة مدير مخوّل، ولا يمكن تغيير نوع الخصم من الكاشير.',
    managerLimitHint: 'هذا هو الحد الأقصى لصلاحية هذا المدير. يمكنه اعتماد خصم موظف آخر ضمن حدّه فقط ولا يمكنه تجاوزه.',
    currentAmountLimit: 'الحد الحالي: حتى {amount}.',
    currentPercentLimit: 'الحد الحالي: حتى {percent}%.',
    override: 'السماح لهذا المدير باعتماد خصم يتجاوز حد موظف آخر، ضمن حدّه.',
    ...
    permissionHint: 'حفظ السياسة يحدّث صلاحيات الموظف تلقائيًا. تغيير نوع الخصم لا يمسح الحدود المحفوظة للنوع الآخر.',
  },
  ku: {
  ...
  en: {
    ...
    subtitle: 'Choose one merchant-wide discount type, then set each employee limit for that type.',
    back: 'Back to cashiers & staff',
    discountType: 'Active discount type',
    discountTypeHint: 'This choice applies to all cashiers and managers. Employees cannot switch the discount type at checkout.',
    amountType: 'Fixed amount', percentageType: 'Percentage', saveType: 'Save discount type', typeSaved: 'Merchant discount type saved.',
    ...
    percentRequired: 'Enter a maximum percentage from 0 to 100.', amountRequired: 'Enter a fixed discount amount greater than zero.',
    ...
    permissionHint: 'Saving updates employee permissions automatically. Changing the active type does not erase the saved limit for the other type.',
  },
};
