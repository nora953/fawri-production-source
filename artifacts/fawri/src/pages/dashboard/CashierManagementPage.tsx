...
const COPY: Record<Lang, Copy> = {
  ...
  ku: {
    ...
    discountWarning: 'دەسەڵاتی داشکاندن خۆکارانە نادرێت. دوای چالاککردن، سنووری کارمەند لە سیاسەتی داشکاندن دیاری بکە. هەر داشکاندنێکی لە سنوور زیاتر پێویستی بە پەسەندی بەڕێوەبەری مۆڵەتپێدراو هەیە.', profitWarning: 'دەسەڵاتی قازانج هەستیارە. تەنها بە کارمەندی متمانەپێکراو بدرێت.', active: 'چالاک', disabled: 'ناچالاک', revoked: 'هەڵوەشاوە', disable: 'ناچالاککردن', enable: 'چالاککردن', edit: 'دەستکاری', cancel: 'پاشگەزبوونەوە', saveChanges: 'پاشەکەوتکردن', editStaff: 'دەستکاری کارمەند', newPin: 'کۆدی چوونەژوورەوەی نوێ (ئارەزوومەندانە)',
    addStation: 'زیادکردنی وێستگەی کاشێر', stationName: 'ناوی وێستگە', branchKey: 'کۆدی لق', branchLabel: 'ناوی لق (ئارەزوومەندانە)', offlineAuthority: 'ڕێگەدان بە ئەم وێستگەیە بۆ فرۆشتنی بەرهەمەکانی کۆگای بەدواداچووکراو لە کاتی پچڕانی ئینتەرنێت', offlineHint: 'تەنها یەک وێستگە لە هەر لقێک دەتوانێت ئەم دەسەڵاتە هەبێت. لە کاتی پچڕانی ئینتەرنێت، وێستگەکانی تر ناتوانن بەرهەمەکانی کۆگای بەدواداچووکراو بفرۆشن، بۆ ڕێگرتن لە ناکۆکی بڕی کۆگا.', offlineBadge: 'فرۆشتنی کۆگا بەبێ ئینتەرنێت', saveStation: 'زیادکردنی وێستگە', editStation: 'دەستکاری وێستگە', paired: 'بەستراوە', notPaired: 'نەبەستراوە', pair: 'دروستکردنی کۆدی بەستنەوە', stationStatus: 'دۆخی وێستگە', disableStation: 'ناچالاککردنی وێستگە', enableStation: 'چالاککردنی وێستگە', activeStationHint: 'ناچالاککردن دەسەڵاتی ئامێری ئێستا دەسڕێتەوە، مناوبەی چالاک کۆتایی پێدێنێت و فرۆشتنی نوێ ڕادەگرێت.', disabledStationHint: 'وێستگەکە ناچالاکە. چالاکی بکە و پاشان کۆدی بەستنەوەی نوێ دروست بکە.', disableStationWarning: 'ناچالاککردنی ئەم وێستگەیە بەستنی ئامێر دەکاتەوە و هەر مناوبەیەکی چالاک کۆتایی پێدێنێت. دوای چالاککردنەوە پێویستە کۆدی بەستنەوەی نوێ دروست بکەیت. بەردەوام بیت؟',
