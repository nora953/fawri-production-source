import { SERVER_PRODUCTS_PAGE_LABELS } from '@/lib/translations/features/pages/dashboard/ServerProductsPage';
...
const LABELS: Record<LanguageCode, Labels> = SERVER_PRODUCTS_PAGE_LABELS;
