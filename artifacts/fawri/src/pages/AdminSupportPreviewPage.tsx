import {
  ADMIN_SUPPORT_PREVIEW_PAGE_COUNT_LABELS,
  ADMIN_SUPPORT_PREVIEW_PAGE_PLAN_LABELS,
  ADMIN_SUPPORT_PREVIEW_PAGE_STATUS_LABELS,
  ADMIN_SUPPORT_PREVIEW_PAGE_TEXT,
} from '@/lib/translations/features/pages/AdminSupportPreviewPage';
...
const TEXT = ADMIN_SUPPORT_PREVIEW_PAGE_TEXT;

const PLAN_LABELS: Record<UiLang, Record<string, string>> = ADMIN_SUPPORT_PREVIEW_PAGE_PLAN_LABELS;

const STATUS_LABELS: Record<UiLang, Record<string, string>> = ADMIN_SUPPORT_PREVIEW_PAGE_STATUS_LABELS;

const COUNT_LABELS: Record<UiLang, Record<string, string>> = ADMIN_SUPPORT_PREVIEW_PAGE_COUNT_LABELS;
