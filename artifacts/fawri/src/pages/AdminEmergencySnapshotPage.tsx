import { ADMIN_EMERGENCY_SNAPSHOT_PAGE_FIELD_LABELS, ADMIN_EMERGENCY_SNAPSHOT_PAGE_STATUS_LABELS } from '@/lib/translations/features/pages/AdminEmergencySnapshotPage';
