...
const COPY: Record<Lang, {
  ...
  ku: {
    endShift: 'کۆتایی شەفت',
    title: 'پشتڕاستکردنەوەی کۆتایی شەفت',
    hint: 'کۆدی PINی کارمەندی ئێستا بنووسە بۆ پشتڕاستکردنەوەی کۆتایی شەفت.',
    pin: 'کۆدی PIN',
    cancel: 'هەڵوەشاندنەوە',
    confirm: 'کۆتایی شەفت',
    confirming: 'شەفت کۆتایی پێدێت...',
    ...
    offline: 'بۆ کۆتایی شەفت پێویستە ئینتەرنێت هەبێت.',
    sessionEnded: 'شەفتی کارمەند کۆتایی هاتووە یان دانیشتنەکە چیتر دروست نییە.',
    failed: 'کۆتاییهێنان بە شەفت سەرکەوتوو نەبوو. دووبارە هەوڵ بدە.',
  },
  en: {
    endShift: 'End shift',
