...
export function SubscriptionCard({ subscription, onEmergencyActivate }: SubscriptionCardProps) {
  ...
  const usagePercent = (subscription.replies_used / subscription.reply_limit) * 100;
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t">
          ...
          <div>
            ...
            <div className="font-medium flex items-center gap-2">
              ...
              {daysRemaining <= 3 && <Badge variant="destructive" className="text-[10px] px-1">{daysRemaining} {t.days_remaining}</Badge>}
            </div>
          </div>
        </div>
