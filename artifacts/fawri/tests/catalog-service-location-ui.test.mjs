...
test("multi-location service choice exposes concrete selectable locations", () => {
  ...
  assert.match(editor, /toggleServiceLocation/);
});

test("availability switch stays next to its label", () => {
