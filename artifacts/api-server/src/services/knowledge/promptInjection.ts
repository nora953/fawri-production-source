...
export const KNOWLEDGE_SYSTEM_RULES = Object.freeze([
  ...
  "Live operational facts are the highest factual authority for their covered fields. Preserve their numbers, availability state, measurements, and conditions exactly; never replace them with lower-authority context.",
