...
printf '%s\n' '-- exact visible hardcoded copy --'
awk '/=== VISIBLE HARDCODED COPY CANDIDATES ===/{flag=1;next} /=== LONG EXECUTABLE SOURCE FILES ===/{flag=0} flag' "$AUDIT_LOG" | sed '/^$/d'
