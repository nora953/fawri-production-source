...
const migrationsFolder = createStabilizedMigrationFolder(
  committedMigrationsFolder,
);
const expected = loadCommittedSchemaExpectation(committedMigrationsFolder);
    ...
    `${JSON.stringify(
      {
        ...
        dependency_order_stabilized: true,
      },
      null,
      2,
    )}\n`,
